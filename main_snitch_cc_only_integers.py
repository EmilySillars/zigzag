...
parser.add_argument(
    ...
    metavar="path",
    required=False,
    default="zigzag/inputs/mapping/snitch-cc-only-integers-mapping.yaml",
...
parser.add_argument(
    ...
    metavar="path",
    required=False,
    default="zigzag/inputs/hardware/snitch-cc-only-integers.yaml",
    # default="zigzag/inputs/hardware/snitch-cc-only-integers-broken.yaml", # causes error
