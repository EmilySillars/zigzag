...
parser.add_argument(
    ...
    metavar="path",
    required=False,
    default="zigzag/inputs/workload/part-of-iree-kernel.yaml",
...
parser.add_argument(
    ...
    metavar="path",
    required=False,
    default="zigzag/inputs/mapping/snitch-cluster-empty-mapping.yaml",
    help="path to mapping file, e.g., zigzag/inputs/mapping/snitch_cluster_empty_mapping.yaml",
)
parser.add_argument(
    "--accelerator",
    metavar="path",
    required=False,
    default="zigzag/inputs/hardware/snitch-cluster-only-floats-yes-ssrs.yaml",
...
mainstage = MainStage(
    ...
    dump_folder=f"outputs_iree_kernel_yes_ssrs/",  # where outputs will be saved to
