...
parser.add_argument(
    ...
    metavar="path",
    required=False,
    default="zigzag/inputs/workload/resnet18-trimmed.yaml",
...
parser.add_argument(
    ...
    metavar="path",
    required=False,
    default="zigzag/inputs/mapping/snitch-cluster-only-integers-multilevel-mapping2.yaml",
...
mainstage = MainStage(
    ...
    dump_folder=f"snitch_cluster_only_integers_multilayer_outputs/",  # where outputs will be saved to
...
cme = answers[0][0]
cmes = answers[0]
save_path = "snitch_cluster_only_integers_multilayer_outputs/breakdown.png"
bar_plot_cost_model_evaluations_breakdown([cme], save_path=save_path, xtick_rotation=0)
from zigzag.visualization.results.print_mapping import print_mapping
print_mapping(answers[0][0])
print("")
print_mapping(answers[1][0])
print("")
print_mapping(answers[2][0])
print("")
